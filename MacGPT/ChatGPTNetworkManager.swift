...
class ChatGPTNetworkManager {
    ...
    func fetchChatGPTResponse(userInput: String, completion: @escaping (String) -> Void) {
        ...
        request.addValue("Bearer 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", forHTTPHeaderField: "Authorization") // Securely replace with your actual API key
